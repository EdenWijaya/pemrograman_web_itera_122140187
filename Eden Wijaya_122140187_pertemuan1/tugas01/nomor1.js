document.addEventListener("DOMContentLoaded", function () {
    ...
    function tambahTodo(text) {
        ...
        li.className = "flex justify-between items-center bg-gray-100 p-3 my-2 rounded";
        ...
        btnHapus.className = "bg-red-800 text-white px-2 py-1 rounded cursor-pointer hover:bg-red-600";
        ...
        btnSelesai.className = "bg-green-800 text-white px-2 py-1 rounded cursor-pointer hover:bg-green-600 ml-2";
